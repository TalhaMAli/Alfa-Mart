...
DATABASES = {
    'default': {
        ...
        'NAME': 'alfa',       # The name of your database
        'USER': 'root',           # Your MySQL username
        'PASSWORD': '',           # Your MySQL password 
        'HOST': 'localhost',      # Set to 'localhost' or '127.0.0.1'
        'PORT': '3306',           # The port MySQL server is running on 
    }
}
...
# STRIPE PAYMENT
STRIPE_PUB_KEY = 'pk_test_51PK0iQRoNBGpv0700rGk1ZCpJPpfUxaZ4Xdcfe9Z4WQLiLttoHET6vRnnJS34gEe2eeZ6h42TgE2MkM9BASZvMPA00P2nkrl5c'  # For JavaScript
STRIPE_SECRET_KEY = 'sk_test_51PK0iQRoNBGpv070ZdC951AokSVeVd9sdMPPwd0jzhhv8EWc9VVZ8PanZzk26U9Cg5AqiiLsp5aeVUQrgTv7HSpl00rthUsnFo'  # For Django Backend
